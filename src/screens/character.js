    ...
    { !isFetching && 
      <Grid container spacing={2} style={{marginTop:"10px"}}>
        <Grid item xs={12} sm={4}>
          ...
          <Paper elevation={4} style={{padding:"2px", textAlign:"center", marginTop:"10px"}}>
        ...
        <Grid item xs={12} sm={8}>
          <Stack spacing={2}>
            ...
            <Paper elevation={2}>
              <h2>Status - {currentCharacter.status=="Alive" ?
                <span>Alive <GoSmiley style={{position:"absolute", marginLeft:"5px", marginTop:"4px", color:"green"}} /></span> :
                <span>Dead<GiDeadHead size={30} style={{position:"absolute", marginLeft:"5px", color:"red"}} /> </span> }
              </h2>
            ...
            <Trait title="Type" content={currentCharacter.type !== "" ? currentCharacter.type : "Unknown"} />
          </Stack>
        </Grid>
      </Grid>
    }  
